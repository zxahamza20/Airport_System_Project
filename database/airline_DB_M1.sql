...
LOAD DATA LOCAL INFILE './database/AIRPLANE_TYPE.csv'
...
LOAD DATA LOCAL INFILE './database/AIRPORT.csv'
INTO TABLE AIRPORT
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './database/AIRPLANE.csv'
INTO TABLE AIRPLANE
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './database/FLIGHT.csv'
INTO TABLE FLIGHT
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './database/FLIGHT_LEG.csv'
...
LOAD DATA LOCAL INFILE './database/FARE.csv'
INTO TABLE FARE
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './database/LEG_INSTANCE.csv'
...
LOAD DATA LOCAL INFILE './database/SEAT.csv'
INTO TABLE SEAT
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE './database/CAN_LAND.csv'
INTO TABLE CAN_LAND
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
